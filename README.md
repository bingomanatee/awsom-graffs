#awsom graffs
> Awesom graphs in easel and famo.us.

[![Build Status](https://travis-ci.org/bingomanatee/awsom-graffs.svg?branch=master)](https://travis-ci.org/bingomanatee/awsom-graffs) [![Dependency Status](https://david-dm.org/bingomanatee/awsom-graffs.svg)](https://david-dm.org/bingomanatee/awsom-graffs) [![devDependency Status](https://david-dm.org/bingomanatee/awsom-graffs.svg)](https://david-dm.org/bingomanatee/awsom-graffs#info=devDependencies)
...
## Release History
 * 2014-05-08   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)